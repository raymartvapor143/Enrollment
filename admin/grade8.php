...
<h1 style="font-size: 50px; " class="text-primary"><i class="fas fa-users"></i>  Grade 8 / <small class="text-warning">Students List</small>  <button onclick="window.print();" class="btn" id="print-btn">
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
     ...
     <li class="breadcrumb-item active" aria-current="page"> Section: CARSON</li>
  </ol>
</nav>
...
<table class="table  table-striped table-hover table-bordered" id="data" style="margin-left: -34.5%; ">
  ...
  <tbody>
    <?php 
      $query=mysqli_query($db_con,'SELECT * FROM `gradeeigth` ORDER BY `gradeeigth`.`datetime` DESC;');
      $i=1;
      ...
      <tr>
        ...
        echo '<td>'.$i.'</td>
          ...
          <td>
            <a class="btn btn-xs btn-warning" href="index.php?page=editstudent8&id='.base64_encode($result['id']).'&photo='.base64_encode($result['photo']).'">
              <i class="fa fa-edit"></i></a>

             &nbsp; <a class="btn btn-xs btn-danger" onclick="javascript:confirmationDelete($(this));return false;" href="index.php?page=delete8&id='.base64_encode($result['id']).'&photo='.base64_encode($result['photo']).'">
